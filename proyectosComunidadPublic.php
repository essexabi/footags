...
<body class="body_admin">
    ...
    <div class="container-fluid col-12 ml-2 ml-sm-5 ml-md-0 w-100 ">
        ...
        <div class="row-cols-1 d-block d-md-none mt-2 ">

            
            <div class="d-block">
                <center><img src="img/comunidad.png" class="img-fluid mb-1 " alt="" width="45px"></center>
            </div>
            <div class=" d-block ">
        ...
        <div class="row w-100 d-none d-md-flex ">
            <div class="col-12   mt-2">
                <h4 class="text-warning text-center display-4"><small>COMUNIDAD</small><img src="img/comunidad.png" class="img-fluid ml-2 mt-1" alt="" width="90px"></h4>
            </div>
            
        </div>
        <div class="row w-100 d-none d-sm-flex" style="margin-top:10%;"></div>
        <div class="row h-10 d-block d-md-none" style="margin-top:5%;"></div>
        ...
        <div class='d-flex flex-row justify-content-end w-100'>
            ...
            if (isset($_POST["submitPublic" . $pId . ""]) && ($_POST["pass"] == $contraseña)) {
            ...
            <?php } else { ?>
                ...
                <div class="w-100">
                    <form class="form-inline" action="proyectosComunidadPublic.php" method="POST">
                        <input class="col-9 form-control form-control-sm h-50 mr-3 ml-1" type="password" placeholder="contraseña" name="pass">
                        <button name="submitPublic<?php echo $pId ?>" class="col-2 btn btn-sm text-light bg-secondary" type="submitPublic"><small>activar</small></button>
                    </form> &nbsp;
                </div>
            <?php } ?>
    </div>
